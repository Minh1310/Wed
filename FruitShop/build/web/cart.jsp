                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <a href="CartControl?service=getAll"
                               class="position-relative me-4 my-auto active">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <%
                                ...
                                List<Cart> ls = (Vector<Cart>)session.getAttribute(key);
                                if(ls==null){
                                %>
                        <p>hello</p>
                            <%
...
<!--                                        <img src="img/vegetable-item-3.png" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">-->
                                            <p class="mb-0 mt-4"><%=ca.getProductID()%></p>
                                    </div>
                                </th>
                                <td>
                                    <p class="mb-0 mt-4"><%=ca.getProductName()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ca.getUnitPrice()%></p>
                                </td>
                                <td>
                                    <form action="CartControl" method="post">
                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                            ...
                                            <input type="text" class="form-control form-control-sm text-center border-0" 
                                                   onchange="update(<%=ca.getProductID()%>,this.value)"
                                                   name="quantity" value="<%=ca.getQuantity()%>">                                               
                                            ...
                                            <input type="hidden" name="ProductID" value="<%=ca.getProductID()%>">
                                            <input type="hidden" name="service" value="update">
                                            <input type="hidden" name="submit">
                                    </form>        
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ca.getQuantity()*ca.getUnitPrice()%></p>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" >
                                        <a href="CartControl?service=remove&ProductID=<%=ca.getProductID()%>">
                ...
                <div class="mt-5">
                    <input type="text" class="border-0 border-bottom rounded me-5 py-3 mb-4" placeholder="Message to our">
                    <a href="CartControl?service=removeAll">
                        ...
                        <div class="row g-4 justify-content-end">
                            <div class="col-8">
                                 <div class="col-md-12 col-lg-6 col-xl-7">
                                     <h1 class="mb-4" style="text-align:center;">Billing details</h1>
                                    <div class="row">
                                ...
                                <div class="bg-light rounded">
                                    <div class="p-4">
                                        ...
                                        <div class="d-flex justify-content-between mb-4">
                                            ...
                                            <p class="mb-0">$<%=request.getAttribute("total")%></p>
                                        </div>
                                        <div class="d-flex justify-content-between">
        ...
        <!--                                <p class="mb-0 text-end">Shipping to Ukraine.</p>-->
                                    ...
                                    <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                        ...
                                        <p class="mb-0 pe-4">$<%=request.getAttribute("total")%></p>
                                    </div>
                                    <button class="btn border-secondary rounded-pill px-4 py-2 text-primary text-uppercase mb-4 ms-5" 
                                            type="submit">                        
                                        Buy     
                                    </button>
