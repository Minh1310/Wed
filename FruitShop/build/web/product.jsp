<%-- Document : product Created on : Jan 30, 2024, 1:49:22 PM Author : Nhat Anh --%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="product/css/sup.css">
        <link rel="stylesheet" type="text/css" href="product/css/actor.css">
        <style>
            .content-items{
                display: none;
            }
    ...
    <body>
        <form action="ProductsControl" method="post">
            <input id="loadButton" onclick="messageAction()" style="display:none;" type="submit" value="getAll">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="ProductsControl?service=getAll&pagination=1" 
                               class="nav-item nav-link active">Product</a>
        ...
        <--<!-- Model search -->
        <form action="ProductsControl" method="get">
                            ...
                            <div class="col-lg-3">
                                <form action="ProductsControl" method="post">
                                    <div class="row g-4">
                                        ...
                                        <input type="hidden" name="service" value="searchPrice">
                                    </div>
                                </form>

                                <div class="row g-4">
                                    <button class="element-feature"
                                            onclick="toggleBabyScreen('addScreen')">Add</button>
                                </div>
                            </div>
                            <div class="col-lg-9">                               
                                <div class="row g-4 justify-content-center">
                                    <% List<Products> rs = null;
                                        rs = (Vector<Products>)request.getAttribute("dataAll");                         
                                            if(rs==null){
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4 content-items pagination<%=pagination%>">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="product/img/fruite-item-5.jpg"
                                                     class="img-fluid w-100 rounded-top"
                                                     alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                 style="top: 10px; right: 10px;">
                                                <a href="ProductsControl?service=remove&ProductID=<%=ls.getProductID()%>">
                                                    <i class="fa" >&#xf00d;</i>
                                                </a>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-dark fs-5 fw-bold mb-0">
                                                        <%=ls.getUnitPrice()%>/item
                                                    </p>
                                                    <a href="#"
                                                       onclick="toggleBabyScreen('updateScreen<%=ls.getProductID()%>')"
                                    ...
                                    <div class="pagination d-flex justify-content-center mt-5" style="display: inline;">
                                        ...
                                        <div class="pagination">
                                            ...
                                            <%
                                                ...
                                                for(int i =1; i <=n ; i++){
                                            %>
                                            <a href="#" onclick="showContent('pagination<%=i%>')" 
                                               class="rounded"><%=i%></a>                                          
                                            <%}%>
        ...
        <div class="baby-screen" id="addScreen">
            ...
            <form action="ProductsControl" method="post">
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="ProductID" placeholder="ProductID">
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="ProductName"
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" list ="SupplierID" type="text" 
                           name="SupplierID" placeholder="SupplierID">
                    <%
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="PackageType"
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="TaxRate" placeholder="TaxRate">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="UnitPrice" placeholder="UnitPrice">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="RecommendedRetailPrice"
                           placeholder="RecommendedRetailPrice">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="TypicalWeightPerUnit"
                           placeholder="TypicalWeightPerUnit">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit" name="service" value="add"
                            onclick="hideBabyScreen('addScreen')"> 
                        Add
                    </button>
        ...
        <%           
            ...
            if(rs!=null){
                for(Products ls : rs){
        %>
        <div class="baby-screen" id="updateScreen<%=ls.getProductID()%>">
            <button type="button" class="btn-close" aria-label="Close"
                    onclick="hideBabyScreen('updateScreen<%=ls.getProductID()%>')"></button>
            <span class="login100-form-title" style="padding-bottom: 20px;">
                UPDATE PRODUCT
            </span>
            <form action="ProductsControl" method="post">
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="ProductID" 
                           value="<%=ls.getProductID()%>"placeholder="ProductID">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" 
                           value="<%=ls.getProductName()%>"name="ProductName"
                           placeholder="ProductName">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" list="SupplierID" type="text" name="SupplierID" 
                           value="<%=ls.getSupplierID()%>" placeholder="SupplierID">
                    <datalist id="SupplierID">
                        <%
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="Color" 
                           value="<%=ls.getColor()%>"placeholder="Color">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="PackageType"
                           value="<%=ls.getPackageType()%>"placeholder="PackageType">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="Size" 
                           value="<%=ls.getSize()%>"placeholder="Size">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="TaxRate" 
                           value="<%=ls.getTaxRate()%>"placeholder="TaxRate">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="UnitPrice" 
                           value="<%=ls.getUnitPrice()%>"placeholder="UnitPrice">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="RecommendedRetailPrice"
                           value="<%=ls.getRecommendedRetailPrice()%>"placeholder="RecommendedRetailPrice">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="TypicalWeightPerUnit"
                           value="<%=ls.getTypicalWeightPerUnit()%>"placeholder="TypicalWeightPerUnit">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit"
                            onclick="hideBabyScreen('updateScreen<%=ls.getProductID()%>')">
                        UPDATE
                    </button>
                    <button class="login100-form-btn" onclick="hideBabyScreen('updateScreen<%=ls.getProductID()%>')">
                        Cancel
                    </button>
