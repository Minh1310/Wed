...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="PurchaseOrderControl?service=getAll&pagination=1" 
                                       class="dropdown-item active">Purchase Order</a>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">SupplierReference</th>
                                <th scope="col">IsOrderFinalized</th>
                        ...
                        <tbody>
                            <%      
                                Vector<PurchaseOrders> rs = null;
                                rs = (Vector<PurchaseOrders>)request.getAttribute("dataAll");
                                if(rs==null){
                            ...
                            <tr class="content-items pagination<%=pagination%>">
                                ...
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getOrderDate()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getDeliveryMethod()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getExpectedDeliveryDate()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getSupplierReference()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getIsOrderFinalized()==1?"done":"wait"%></p>
                                </td>  
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" 
                                            onclick="toggleBabyScreen('updateScreen<%=ls.getPurchaseOrderID()%>')">
                                        <i style="color: green;" class="fa fa-wrench"></i>
                                    </button>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4">
                                        <a href="PurchaseOrderControl?service=remove&PurchaseOrderID=<%=ls.getPurchaseOrderID()%>">
        ...
        <div class="baby-screen" id="addScreen">
            ...
            <form action="PurchaseOrderControl" method="post">
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="PurchaseOrderID" placeholder="PurchaseOrderID">         
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="date" name="OrderDate" placeholder="OrderDate">              
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="DeliveryMethod" placeholder="DeliveryMethod">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="date" name="ExpectedDeliveryDate" placeholder="ExpectedDeliveryDate">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="SupplierReference" placeholder="SupplierReference">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">        
                    <select class="input100" type="text" name="IsOrderFinalized" 
                            placeholder="IsOrderFinalized">
        ...
        <%
            ...
            for(PurchaseOrders ls : rs){
        %>
        <div class="baby-screen" id="updateScreen<%=ls.getPurchaseOrderID()%>">
            <button type="button" class="btn-close" aria-label="Close"
                    onclick="hideBabyScreen('updateScreen<%=ls.getPurchaseOrderID()%>')"></button>
            <span class="login100-form-title" style="padding-bottom: 20px;">
                UPDATE PurchaseOrders
            </span>
            <form action="PurchaseOrderControl" method="post">
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="PurchaseOrderID" 
                           value="<%=ls.getPurchaseOrderID()%>"
                ...
                <div class="wrap-input100 validate-input">        
                    ...
                    <select class="input100" type="text" name="SupplierID" 
                        ...
                        <%                           
                             if(sp!=null){
                                 for(Suppliers list : sp){
                                     if(ls.getSupplierID()==list.getSupplierID()){
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="date" name="OrderDate" 
                           value="<%=ls.getOrderDate()%>"
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="DeliveryMethod" 
                           value="<%=ls.getDeliveryMethod()%>"
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="date" name="ExpectedDeliveryDate" 
                           value="<%=ls.getExpectedDeliveryDate()%>"
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="SupplierReference" 
                           value="<%=ls.getSupplierReference()%>"
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit" 
                            onclick="hideBabyScreen('updateScreen<%=ls.getPurchaseOrderID()%>')">
                        UPDATE
                    </button>
