...
<%@page import="java.util.*, entity.Suppliers" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        <form action="SupplierControl" method="post">
            <input id="loadButton" style="display: none;" type="submit">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="SupplierControl?service=getAll&pagination=1" 
                                       class="dropdown-item active">Manage account</a>
        ...
        <!-- Modal Search Start -->
        <form action="SupplierControl" method="get">
            ...
            <div class="container py-5">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <%      
                                Vector<Suppliers> rs = null;
                                rs = (Vector<Suppliers>)request.getAttribute("dataAll");
                                if(rs==null){
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0 mt-4"><%=ls.getSupplierName()%></p>
                                    </div>
                                </th>                                        
                                <td>
                                ...
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" 
                                            onclick="toggleBabyScreen('updateScreen<%=ls.getSupplierID()%>')">
                                        <i style="color: green;" class="fa fa-wrench"></i>
                                    </button>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4">
                                        <a href="SupplierControl?service=remove&id=<%=ls.getSupplierID()%>">
                                            <i class="fa fa-times text-danger"></i></a>
                                    </button>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4">
                                        <a href="SupplierControl?service=detail&id=<%=ls.getSupplierID()%>">
                                            <i class="fa fa-times text-danger"></i></a>
                                    </button>
                                </td>
                            </tr>
                ...
                <!--                <div class="mt-5">
                                    ...
                                    <form action="SupplierControl" method="post">                
                                        ...
                                        <input type="hidden" name="service" value="getAll">                   
                                        <button class="btn border-secondary rounded-pill px-4 py-3 text-primary" onclick="toggleBabyScreen('removeScreen')" type="button">Remove </button>
                                        <button class="btn border-secondary rounded-pill px-4 py-3 text-primary" onclick="toggleBabyScreen('updateScreen')" type="button">Update </button>
                                    </form>
        ...
        <%
            if(rs!=null){
                for(Suppliers ls : rs){%>
        <div class="baby-screen" id="updateScreen<%=ls.getSupplierID()%>">
            <button type="button" class="btn-close" aria-label="Close"
                    onclick="hideBabyScreen('updateScreen<%=ls.getSupplierID()%>')"></button>
            ...
            <form action="SupplierControl" method="post">                   
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="userName" 
                           value="<%=ls.getSupplierName()%>" placeholder="User Name">
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="password" 
                           value="<%=ls.getSupplierReference()%>" placeholder="Password">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit" onclick="hideBabyScreen('updateScreen<%=ls.getSupplierID()%>')">
                        UPDATE
                    </button>
                    <input type="hidden" name="submit" value="submit">
                    <input type="hidden" name="ID" value="<%=ls.getSupplierID()%>">    
