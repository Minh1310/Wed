                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <%
                                ...
                                List<Bill> ls = (Vector<Bill>)session.getAttribute("bill");
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 mt-4"><%=ca.getBillID()%></p>
                                    </div>
                                </th>
                                <td>
                                    <p class="mb-0 mt-4"><%=ca.getFirstName()+" "+ca.getLastName()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ca.getDate()%></p>
                                </td>                           
                                <td>
                                    <p class="mb-0 mt-4"><%=ca.getTotal()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ca.getStatus()==1?"done":"wait"%></p>
                                </td>
                                <td>
                                    <a href="BillControl?service=detail&index=<%=index-1%>">
