...
<%@page import="java.util.*, entity.SupplierCategories" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        <form action="SupplierCategoriesControl" method="post">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="SupplierCategoriesControl?service=getAll&pagination=1"
                                       class="dropdown-item active">Categories</a>
        ...
        <!-- Modal Search Start -->
        <form action="SupplierCategoriesControl" method="get">
            ...
            <div class="container py-5">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <%      
                                Vector<SupplierCategories> rs = null;
                                rs = (Vector<SupplierCategories>)request.getAttribute("dataAll");
                                if(rs==null){
                                    ...
                                    int pagination = 1;
                                    int count = 0;
                                    for(SupplierCategories ls : rs){%>

                            <tr class="content-items pagination<%=pagination%>">
                                <!--  -->
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="img/vegetable-item-3.png" class="img-fluid me-5 rounded-circle" style="width: 40px; height: 40px;" alt="">
                                    </div>
                                </th>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getSupplierCategoryID()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getSupplierCategoryName()%></p>
                                </td>  
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" 
                                            onclick="toggleBabyScreen('updateScreen<%=ls.getSupplierCategoryID()%>')">
                                        <i style="color: green;" class="fa fa-wrench"></i>
                                    </button>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4">
                                        <a href="SupplierCategoriesControl?service=remove&SupplierCategoryID=<%=ls.getSupplierCategoryID()%>">
...
<div class="baby-screen" id="addScreen">
    ...
    <form action="SupplierCategoriesControl" method="post">
        <div class="wrap-input100 validate-input">
            <input class="input100" type="text" name="SupplierCategoryID" placeholder="SupplierCategoryID">
        ...
        <div class="wrap-input100 validate-input">
            <input class="input100" type="text" name="SupplierCategoryName" placeholder="SupplierCategoryName">
            <span class="focus-input100"></span>
            <span class="symbol-input100">
                <i class="fa fa-inbox" aria-hidden="true"></i>
            </span>
...
%>
<div class="baby-screen" id="updateScreen<%=ls.getSupplierCategoryID()%>">
    <button type="button" class="btn-close" aria-label="Close"
            onclick="hideBabyScreen('updateScreen<%=ls.getSupplierCategoryID()%>')">
    </button>
    <span class="login100-form-title" style="padding-bottom: 20px;">
        UPDATE CATEGORIEST
    </span>
    <form action="SupplierCategoriesControl" method="post">
        <div class="wrap-input100 validate-input">
            <input class="input100" type="text" name="SupplierCategoryID" 
                   value="<%=ls.getSupplierCategoryID()%>"
                   placeholder="SupplierCategoryID">
            <span class="focus-input100"></span>
            <span class="symbol-input100">
                <i class="fa fa-inbox" aria-hidden="true"></i>
            </span>
        ...
        <div class="wrap-input100 validate-input">
            <input class="input100" type="text" name="SupplierCategoryName" 
                   value="<%=ls.getSupplierCategoryName()%>"
                   placeholder="SupplierCategoryName">
            <span class="focus-input100"></span>
            <span class="symbol-input100">
                <i class="fa fa-inbox" aria-hidden="true"></i>
            </span>
