...
<html lang="en">
    ...
    <body>
        <form action="PurchaseOrderLineControl" method="post">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="PurchaseOrderLineControl?service=getAll&pagination=1"
                                       class="dropdown-item active">Purchase Order Line</a>
        ...
        <!-- Modal Search Start -->
        <form action="PurchaseOrderLineControl" method="get">
            ...
            <div class="container py-5">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">PurchaseOrderLineID</th>
                                <th scope="col">PurchaseOrderID</th>
                                <th scope="col">ProductID</th>
                                <th scope="col">OrderedQuantity</th>
                                <th scope="col">Description</th>
                                <th scope="col">ReceivedQuantity</th>
                                <th scope="col">LastReceiptDate</th>
                                <th scope="col">IsOrderLineFinalized</th>
                        ...
                        <tbody>
                            <%      
                                Vector<PurchaseOrderLines> rs = null;
                                rs = (Vector<PurchaseOrderLines>)request.getAttribute("dataAll");
                                if(rs==null){
                                    ...
                                    int pagination = 1;
                                    int count = 0;
                                    for(PurchaseOrderLines ls : rs){%>
                            <tr class="content-items pagination<%=pagination%>">
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0 mt-4"><%=ls.getPurchaseOrderLineID()%></p>
                                    </div>
                                </th>                                        
                                <td>
                                ...
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getProductID()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getOrderedQuantity()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getDescription()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getReceivedQuantity()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.getLastReceiptDate()%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%=ls.isIsOrderLineFinalized()==1?"done":"wait"%></p>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" 
                                            onclick="toggleBabyScreen('updateScreen<%=ls.getPurchaseOrderLineID()%>')">
                                        <i style="color: green;" class="fa fa-wrench"></i>
                                    </button>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4">
                                        <a href="PurchaseOrderLineControl?service=remove&PurchaseOrderLineID=<%=ls.getPurchaseOrderLineID()%>">
                ...
                <div class="mt-5">
                    ...
                    <form action="PurchaseOrderLineControl" method="post">                
                        ...
                        <input type="hidden" name="service" value="getAll">
                        <button class="btn border-secondary rounded-pill px-4 py-3 text-primary" 
                                onclick="toggleBabyScreen('addScreen')" 
        ...
        <div class="baby-screen" id="addScreen">
            ...
            <form action="PurchaseOrderLineControl" method="post">
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="PurchaseOrderLineID" placeholder="PurchaseOrderLineID">
                ...
                <div class="wrap-input100 validate-input">        
                    <%
                        ...
                        Vector<Products> pro = null;
                        po = (Vector<PurchaseOrders>)request.getAttribute("PurchaseOrders");
                        pro = (Vector<Products>)request.getAttribute("Products");
                    %>
                ...
                <div class="wrap-input100 validate-input">        
                    <select class="input100" type="text" name="ProductID" 
                            placeholder="ProductID">
                        <%

                             if(pro!=null){
                                 for(Products list : pro){                                                                   
                        %>
                        <option value="<%=list.getProductID()%>">
                            <%=list.getProductID()%></option>
                            <%}}%>
                    </select>
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="OrderedQuantity" placeholder="OrderedQuantity">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="ReceivedQuantity" placeholder="ReceivedQuantity">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="date" name="LastReceiptDate" placeholder="LastReceiptDate">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">        
                    <select class="input100" type="text" name="IsOrderLineFinalized" 
                            placeholder="IsOrderLineFinalized">
        ...
        <%
            ...
            for(PurchaseOrderLines ls : rs){
        %> 
        <div class="baby-screen" id="updateScreen<%=ls.getPurchaseOrderLineID()%>">
            <button type="button" class="btn-close" aria-label="Close"
                    onclick="hideBabyScreen('updateScreen<%=ls.getPurchaseOrderLineID()%>')"></button>
            <span class="login100-form-title" style="padding-bottom: 20px;">
                UPDATE 
            </span>
            <form action="PurchaseOrderLineControl" method="post">
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="PurchaseOrderLineID" 
                           value="<%=ls.getPurchaseOrderLineID()%>" placeholder="PurchaseOrderLineID">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <select class="input100" type="text" name="PurchaseOrderID" 
                            value="<%=ls.getPurchaseOrderID()%>" placeholder="PurchaseOrderID">
                        <%
                ...
                <div class="wrap-input100 validate-input">        
                    <select class="input100" type="text" name="ProductID" 
                            value="<%=ls.getPurchaseOrderID()%>" placeholder="ProductID">
                        <%
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="OrderedQuantity" 
                           value="<%=ls.getOrderedQuantity()%>" placeholder="OrderedQuantity">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="Description" 
                           value="<%=ls.getDescription()%>" placeholder="Description">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="text" name="ReceivedQuantity" 
                           value="<%=ls.getReceivedQuantity()%>" placeholder="ReceivedQuantity">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">
                    <input class="input100" type="date" name="LastReceiptDate" 
                           value="<%=ls.getLastReceiptDate()%>" placeholder="LastReceiptDate">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                    </span>
                ...
                <div class="wrap-input100 validate-input">        
                    <select class="input100" type="text" name="IsOrderLineFinalized" 
                            value="<%=ls.isIsOrderLineFinalized()%>" placeholder="IsOrderLineFinalized">
                        <%
                            if(ls.isIsOrderLineFinalized()==1){
                        %>
                ...
                <div class="container-login100-form-btn">                   
                    <button class="login100-form-btn" type="submit" 
                            onclick="hideBabyScreen('updateScreen<%=ls.getPurchaseOrderLineID()%>')">
                        UPDATE
                    </button>
